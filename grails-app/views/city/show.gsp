            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="city.routes.label" default="Routes" /></td>
                            
                            <td valign="top" style="text-align: left;" class="value">
                                <ul>
                                <g:each in="${cityInstance.routes}" var="r">
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="city.shortCode.label" default="Short Code" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: cityInstance, field: "shortCode")}</td>
